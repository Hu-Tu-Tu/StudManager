...
function course_avg() {
    ...
    var url = "/StudManager_war_exploded/AdminDao?action=course_avg";
...
function fail_rate() {
    ...
    var url = "/StudManager_war_exploded/AdminDao?action=fail_rate";
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
//显示查询成绩排名信息
...
function course_ranking() {
    ...
    var url = "/StudManager_war_exploded/AdminDao?action=course_ranking&cno=" + Cno;
...
function insert(object) {
    ...
    if (object == "user") {
        ...
        url = "/StudManager_war_exploded/AdminDao?action=insert_user&username=" + username + "&password=" + password + "&level=" + level;
    }
        ...
        url = "/StudManager_war_exploded/AdminDao?action=insert_department&dno=" + dno + "&dname=" + dname;
    }
        ...
        url = "/StudManager_war_exploded/AdminDao?action=insert_class&clno=" + clno + "&clname=" + clname + "&dno=" + dno;
    }
        ...
        url = "/StudManager_war_exploded/AdminDao?action=insert_student&sno=" + sno + "&sname=" + sname + "&ssex=" + ssex + "&sage=" + sage + "&clno=" + clno;
    }
        ...
        url = "/StudManager_war_exploded/AdminDao?action=insert_course&cno=" + cno + "&cname=" + cname + "&cteacher=" + cteacher + "&ccredit=" + ccredit;
    }
    else if (object == "sc") {
        ...
        url = "/StudManager_war_exploded/AdminDao?action=insert_sc&sno=" + sno + "&cno=" + cno + "&grade=" + grade;
    }
    else {
        url = "/StudManager_war_exploded/message.jsp";
    }
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
...
function delete_user() {
    ...
    var username = user[0].value.toString();
    var url = "/StudManager_war_exploded/AdminDao?action=delete_user&username=" + username;
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
//删除院系
function delete_department() {
    ...
    var url = "/StudManager_war_exploded/AdminDao?action=delete_department&dno=" + dno;
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
//删除班级
function delete_class() {
    ...
    var url = "/StudManager_war_exploded/AdminDao?action=delete_class&clno=" + clno;
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
//删除学生
function delete_student() {
    ...
    var url = "/StudManager_war_exploded/AdminDao?action=delete_student&sno=" + sno;
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
//删除课程
function delete_course() {
    ...
    var url = "/StudManager_war_exploded/AdminDao?action=delete_course&cno=" + cno;
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
//删除成绩
function delete_sc() {
    ...
    var url = "/StudManager_war_exploded/AdminDao?action=delete_sc&sno=" + sno + "&cno="+cno;
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
/*-----------------------------------修改---------------------------------*/
...
function alter_user() {
    ...
    var url = "/StudManager_war_exploded/AdminDao?action=alter_user&username=" + username + "&after_username=" + after_username + "&after_password=" + after_password + "&after_level=" + after_level;
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
//修改院系
function alter_department() {
    ...
    var url = "/StudManager_war_exploded/AdminDao?action=alter_department&dno=" + dno + "&after_dno=" + after_dno + "&after_dname" + after_dname;
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
//修改班级
function alter_class() {
    ...
    var url = "/StudManager_war_exploded/AdminDao?action=alter_class&clno=" + clno + "&after_clno=" + after_clno + "&after_clname=" + after_clname + "&after_dno=" + after_dno;
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
//修改学生
function alter_student() {
    ...
    var url = "/StudManager_war_exploded/AdminDao?action=alter_student&sno=" + sno + "&after_sno=" + after_sno + "&after_sname=" + after_sname + "&after_ssex=" + after_ssex+"&after_sage="+after_sage+"&after_clno="+after_clno;
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
//修改课程
function alter_course() {
    ...
    var url = "/StudManager_war_exploded/AdminDao?action=alter_course&cno=" + cno + "&after_cno=" + after_cno + "&after_cname=" + after_cname + "&after_cteacher=" + after_cteacher+"&after_ccredit="+after_ccredit;
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}
//修改成绩
function alter_sc() {
    ...
    var url = "/StudManager_war_exploded/AdminDao?action=alter_sc&sno=" + sno + "&cno=" + cno + "&after_grade=" + after_grade;
    xmlhttp.open("GET", url, true);
    xmlhttp.send();
}